...
describe('UsersService', () => {
  ...
  describe('create', () => {
    it('should throw ConflictException if email exists', async () => {
      ...
      await expect(
        service.registerUser({ name: 'Test', email: 'a@a.com' } as CreateUserDto),
  ...
  describe('update', () => {
    it('should throw if user not found', async () => {
      (repo.findOneBy as jest.Mock).mockResolvedValue(null);
      await expect(
        service.updateUser(5, { name: 'N' } as UpdateUserDto),
      ).rejects.toBeInstanceOf(ConflictException);
    ...
    it('should merge, save and clear cache if found', async () => {
      ...
      const result = await service.updateUser(6, dto);
  ...
  describe('remove', () => {
    it('should throw if user not found', async () => {
      (repo.findOneBy as jest.Mock).mockResolvedValue(null);
      await expect(service.deleteUser(7)).rejects.toBeInstanceOf(ConflictException);
